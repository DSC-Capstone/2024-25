...
- Each GitHub user is allowed to create one personal website, published at `<username>.github.io`. 
    ...
    - As another example, is at [surajrampure.github.io](https://surajrampure.github.io), and its source code is in [github.com/surajrampure/surajrampure.github.io](https://github.com/surajrampure/surajrampure.github.io). Since this has a custom domain setup, the link appears as [rampure.org](https://rampure.org), however.
